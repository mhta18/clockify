...
class Contract(models.Model):
    user = models.OneToOneField(
        User, on_delete=models.CASCADE, related_name="contract", verbose_name=_("user")
    )
    role_title = models.CharField(max_length=255, verbose_name=_("role title"))
    ...
    is_terminated = models.BooleanField(default=False, verbose_name=_("is terminated"))
...
class FreelancerContract(Contract):
    hourly_payment = models.DecimalField(
        max_digits=10, decimal_places=2, verbose_name=_("hourly payment")
    )
...
class EmployerContract(Contract):
    ...
    monthly_payment = models.DecimalField(
        max_digits=10, decimal_places=2, verbose_name=_("monthly payment")
    )
